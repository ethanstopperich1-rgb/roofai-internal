    ...
    <div className="glass rounded-2xl p-5 space-y-5">
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <button className="btn btn-ghost px-3" onClick={() => set("sqft", Math.max(200, value.sqft - 100))}>
            <Minus size={16} />
          </button>
          <input
            type="number"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select className="input" value={value.pitch} onChange={(e) => set("pitch", e.target.value as Pitch)}>
            {PITCHES.map((p) => (
